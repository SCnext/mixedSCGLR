...
#' of the Congo-Basin and 56 geo-referenced environmental variables on one thousand 8 by 8 km plots
...
#' @format
#' \tabular{ll}{
#'    \code{gen1 to gen8} \tab abundance of the 8 common genera.\cr
